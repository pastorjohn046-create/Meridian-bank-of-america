...
import { ArrowUpRight, ArrowDownLeft, Plus, CreditCard, X, Send, ArrowLeftRight, History, Headset } from 'lucide-react';
    ...
    >
      ...
      <div className="flex flex-wrap justify-between gap-4">
        {[
          ...
          { icon: Headset, label: 'Support', color: 'bg-zinc-900 text-white', onClick: () => navigate('/support') },
        ].map((action, i) => (
          <button key={i} onClick={action.onClick} className="flex flex-col items-center gap-2 flex-1 min-w-[64px]">
